...
def who_do_you_know():
    ...
    names_without_spaces = [person.strip() for person in names.split(",")]
    # names_without_spaces = [person.strip() for person in input("Please type the list of names of people you know, and separate by comma: ").split(",")]
